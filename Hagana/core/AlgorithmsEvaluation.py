...
class AlgorithmsEvaluation:
    ...
    def runDefaultTest(self):
        ...
        bestModel = self._runTest(models)
    ...
    def _getDefaultModels(self):
        ...
        elif self.__applicationType == self.__ML_APP_REGRESSION:
...
#        models.append(('GPM',GaussianProcessClassifier())) # EXPENSIVE
    ...
    def _defaultRegressionModels(self):
        ...
        models.append(('KR', kr))
        mlp = MLPRegressor()
        param_grid = {'hidden_layer_sizes': [5,10],#[i for i in range(1,15)]
              'activation': ['relu'],
              'solver': ['adam'],
