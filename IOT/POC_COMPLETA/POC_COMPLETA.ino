// Este codigo utiliza a placa ESP8266.
// A instalacao da placa e um pouco trabalhosa mas existem varios tutoriais disponiveis na internet.
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IMPORTANTE
// E NECESSARIO ATUALIZAR fingerprint PARA HTTPS
    ...
    if (https.begin(*client, "https://api.primebuilder.com.br/main/auth")) {
      ...
      if (httpCode > 0) {
        if (httpCode == HTTP_CODE_OK || httpCode == HTTP_CODE_MOVED_PERMANENTLY) {
          ...
          TOKEN = generate_authorization(payload);  // "bearer + payload[
        }
      }
      https.end();
    }
...
String generate_json(int measure){
    ...
    doc["Workflow"] = 26801;
    doc["Group"] = 5343;
    doc_nested["Street"] = "Breno Fernandes";
    doc_nested["Number"] = String(measure);
    doc_nested["Complement"] = "Casa";
    doc_nested["Neighborhood"] = "";
    doc_nested["City"] = "Campinas";
    doc_nested["StateAcronym"] = "SP";
